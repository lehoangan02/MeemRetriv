...
class MemeTextCleaner:
    ...
    def _load_lama_model(self):
        ...
        # MPS only supports float32, no half precision
        if self.device == "mps":
    ...
    def clean_file(self, input_path, output_path):
        ...
        with torch.no_grad():
            ...
            mask_t = mask_t = mask_t.to(self.device)
...
if __name__ == "__main__":
    ...
    cleaner.clean_file(input_path="./image_3889.jpg", output_path="./cleaned_image_3889.jpg")